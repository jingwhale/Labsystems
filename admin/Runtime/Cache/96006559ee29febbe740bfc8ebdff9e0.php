	...
	<br></br>
   	...
   	<form action="__URL__/<?php echo ($btn_ok_act); ?>"  method="post">
		...
		<div>
			...
			<input type="text" id="txtTitle" name="subject" style="width:560px; height:20px; float:left;" maxlength="100" value="<?php echo ($news_item["subject"]); ?>"/>
		</div>
		<br></br>
	    ...
	    <div id="myEditor">
			<script type="text/javascript">
				var editor = new baidu.editor.ui.Editor({
				    initialContent: '<?php echo ($news_item["message"]); ?>'
				});
