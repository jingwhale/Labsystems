	...
	<br></br>
   	...
   	<form action="__URL__/<?php echo ($btn_ok_act); ?>"  method="post">
		...
		<div>
			...
			<input type="text" id="txtTitle" name="title" style="width:560px; height:20px; float:left;" maxlength="100" value="<?php echo ($article_item["title"]); ?>"/>
		</div>
		<br></br>
		<p class="subtit">文章摘要</p>
		<input type="text" id="txtTitle" name="abstract" style="width:560px; height:20px; float:left;" maxlength="1000" value="<?php echo ($article_item["abstract"]); ?>"/>
		<br></br>
